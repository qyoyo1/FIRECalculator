...
const state = {
  ...
  fireAge: 40,
  assets: [
    { key: "cash", label: "Cash", amount: 120000, currency: "CHF" },
    { key: "equity", label: "Equity", amount: 220000, currency: "CHF" },
    { key: "realEstate", label: "Real Estate", amount: 0, currency: "CHF" },
    { key: "pension", label: "Pension", amount: 160000, currency: "CHF" },
  ],
  expectedIncomeInputs: {
    ...
    sharedExpenses: { amount: 60000, currency: "CHF", sign: -1, label: "Shared expenses" },
  },
};
